...
data_test_list = 'data/imagenet/meta/subdataset/val_labeled_50percent_10interval_no_label.txt.txt'
...
# optimizer
optimizer = dict(
    type='SGD', lr=0.05, momentum=0.9, weight_decay=0.0001, nesterov=False)
# learning policy
lr_config = dict(
    policy='step',
    step=[30, 50],
