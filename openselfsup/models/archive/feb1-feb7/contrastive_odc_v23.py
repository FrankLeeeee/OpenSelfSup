...
class ContrastiveODC_V23(nn.Module):
    ...
    def __init__(self,
        ...
        super(ContrastiveODC_V23, self).__init__()
    ...
    def forward_train(self, img, idx, **kwargs):
        ...
        cls_pos = torch.log(torch.exp(torch.mul(feat_after_update.unsqueeze(1), pos_features).sum(dim=1)).sum(dim=1).unsqueeze(1))
