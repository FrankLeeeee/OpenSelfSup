...
class ContrastiveODC_V24_ABL_STUDY_2(nn.Module):
    ...
    def __init__(
        ...
        super(ContrastiveODC_V24_ABL_STUDY_2, self).__init__()
    ...
    def forward_train(self, img, idx, **kwargs):
        ...
        outs_norm_odd_cls_score = torch.matmul(
            outs_norm_odd, self.memory_bank.centroids.permute(1, 0))
        outs_norm_even_cls_score = torch.matmul(
            outs_norm_even, self.memory_bank.centroids.permute(1, 0))
