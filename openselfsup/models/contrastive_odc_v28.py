...
class ContrastiveODC_V28(nn.Module):
    ...
    def __init__(
        ...
        super(ContrastiveODC_V28, self).__init__()
    ...
    def forward_train(self, img, idx, **kwargs):
        ...
        outs_norm_cls_score = torch.matmul(
            feature_norm, self.memory_bank.centroids.permute(1, 0))
        ...
        # loss input
        loss_inputs = dict()
        loss_inputs['cls_scores'] = [outs_norm_cls_score]
