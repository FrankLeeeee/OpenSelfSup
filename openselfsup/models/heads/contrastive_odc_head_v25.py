...
class ContrastiveODCHead_V25(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=1000,
                 temperature=0.1):
        super(ContrastiveODCHead_V25, self).__init__()
        self.alpha = alpha
        self.beta = beta
    ...
    def calc_cls_score_ctc_loss(self, outs_to_odc, outs_to_cts):
        return self.cls_score_contrastive_criterion(outs_to_odc, outs_to_cts)
    ...
    def loss(self,
        ...
        cls_score_mse_loss = self.calc_cls_score_ctc_loss(feature_to_odc, feature_to_cts)
        losses = dict()
        losses['ins_cts_loss'] = ins_cts_loss
        losses['cls_cts_loss'] = cls_cts_loss
        losses['cls_score_mse_loss'] = cls_score_mse_loss
        losses['loss'] = ins_cts_loss + cls_cts_loss + cls_score_mse_loss
