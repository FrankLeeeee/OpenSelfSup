...
class ContrastiveODCHead_V6(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=1000,
                 temperature=0.1):
        super(ContrastiveODCHead_V6, self).__init__()
        self.alpha = alpha
        self.beta = beta
    ...
    def loss(self,
        ...
        # cts_loss = self.calc_cts_loss(negative)
        losses = dict()
        losses['cls_loss'] = cls_loss
        # losses['cts_loss'] = cts_loss
        losses['acc'] = acc
        # losses['loss'] = cls_loss + cts_loss
