...
class ContrastiveODCHead_V22(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=1000,
                 temperature=0.1):
        super(ContrastiveODCHead_V22, self).__init__()
        self.alpha = alpha
        self.beta = beta
    ...
    def loss(self,
        ...
        cls_score_ctc_loss = self.calc_cls_score_ctc_loss(cls_score_1, cls_score_2)

        losses = dict()
        losses['ins_cts_loss'] = ins_cts_loss
        losses['cls_cts_loss'] = cls_cts_loss
        losses['cls_loss'] = cls_loss
        losses['cls_score_ctc_loss'] = cls_score_ctc_loss
        losses['acc'] = acc
        losses['loss'] = ins_cts_loss + cls_cts_loss + cls_loss + cls_score_ctc_loss
