...
class ContrastiveODCHead_V14(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=1000,
                 temperature=0.1):
        super(ContrastiveODCHead_V14, self).__init__()
        self.alpha = alpha
        self.beta = beta
    ...
    def loss(self,
        ...
        ins_cts_loss = self.calc_cts_loss(instance_positive, instance_negative)
        cluster_cts_loss = self.calc_cts_loss(
